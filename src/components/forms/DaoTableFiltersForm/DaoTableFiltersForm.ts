...
// import { TokensMutations } from '@/store/modules/tokens/names/mutations.names';
...
// import { TokensGetters } from '@/store/modules/tokens/names/getters.names';
...
//     const isLoadingDaoList = computed(() => <boolean>getters[`${ModulesNames.DAO}/${TokensGetters.IS_LOADING_DAO_LIST}`]);
//
//     onMounted(() => {
//       watch(() => values, async() => {
//         await submitForm();
...
//       commit(`${ModulesNames.DAO}/${TokensMutations.SET_DAO_FILTERS}`, values);
//     });
//
//     const resetFilters = () => {
//       handleReset();
